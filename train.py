...
def TakeImages(): 
    if (len(txt.get()) != 0) and (len(txt2.get()) != 0):
        ...
        if(is_number(Id) and final.isalpha()):
            ...
            harcascadePath = "C:/Users/Hello/Downloads/Face-Recognition/haarcascade_frontalface_default.xml"
            ...
            while(True):
                ...
                for (x,y,w,h) in faces:
                    ...
                    cv2.imwrite("C:/Users/Hello/Downloads/Face-Recognition/TrainingImage/ "+name +"."+Id +'.'+ str(sampleNum) + ".jpg", gray[y:y+h,x:x+w])
                    #display the frame
            ...
            row = [Id , name]
            with open('C:/Users/Hello/Downloads/Face-Recognition/StudentDetails/StudentDetails.csv','a+') as csvFile:
...
def TrainImages():
    if  os.listdir('C:/Users/Hello/Downloads/Face-Recognition/TrainingImage') :
    # Store configuration file values
        ...
        harcascadePath = "C:/Users/Hello/Downloads/Face-Recognition/haarcascade_frontalface_default.xml"
        detector =cv2.CascadeClassifier(harcascadePath)
        faces,Id = getImagesAndLabels("C:/Users/Hello/Downloads/Face-Recognition/TrainingImage")
        recognizer.train(faces, np.array(Id))
        recognizer.write("C:/Users/Hello/Downloads/Face-Recognition/TrainingImageLabel/Trainner.yml")
...
def TrackImages():
    exists = os.path.isfile('C:/Users/Hello/Downloads/Face-Recognition/TrainingImageLabel/Trainner.yml')
    if exists:
        #recognizer = cv2.face.createLBPHFaceRecognizer()
        recognizer = cv2.face.LBPHFaceRecognizer_create()
        #cv2.createLBPHFaceRecognizer()
        recognizer.read("C:/Users/Hello/Downloads/Face-Recognition/TrainingImageLabel/Trainner.yml")
        harcascadePath = "C:/Users/Hello/Downloads/Face-Recognition/haarcascade_frontalface_default.xml"
        faceCascade = cv2.CascadeClassifier(harcascadePath);    
        df=pd.read_csv("C:/Users/Hello/Downloads/Face-Recognition/StudentDetails/StudentDetails.csv")
        cam = cv2.VideoCapture(0)
            ...
            if ret:
                ...
                for(x,y,w,h) in faces:
                    ...
                    if(conf > 55):
                        #temp=(", ".join(aa))
                        name=(", ".join(aa))
                        noOfFile=len(os.listdir("C:/Users/Hello/Downloads/Face-Recognition/ImagesUnknown"))+1
                        cv2.imwrite("C:/Users/Hello/Downloads/Face-Recognition/ImagesUnknown/Image"+str(noOfFile) + ".jpg", im[y:y+h,x:x+w])     
        ...
        fileName="C:/Users/Hello/Downloads/Face-Recognition/Attendance/Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
...
trackImg = tk.Button(window, text="Track Images", command=TrackImages  ,fg="white"  ,bg="orange2"  ,width=20  ,height=3, activebackground = "grey" ,font=('times', 20, ' bold '))
